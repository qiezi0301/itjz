...
$(function() {
    ...
    $("#search_input").keyup(function(event) {
        ...
        if (keyword != "" && keyword != '请输入搜索内容') {
            var mtype = $("#mtype_index").val() > 0 ? $("#mtype_index").val() : 2;

            var li = "<a onclick=editSearchKeyword('" + keyword + "',2) data-mtype=2 id='search_mtype_2'  " + getMtypeOn(mtype, '2') + "> 搜索含<span class='red'>" + keyword + "</span>的网页特效</a>\n\
...
<a onclick=editSearchKeyword('" + keyword + "',15) data-mtype=15 id='search_mtype_15' " + getMtypeOn(mtype, '15') + "> 搜索含<span class='red'>" + keyword + "</span>的整站源码</a>\n\
...
<a onclick=editSearchKeyword('" + keyword + "',21) data-mtype=21 id='search_mtype_21' " + getMtypeOn(mtype, '21') + "> 搜索含<span class='red'>" + keyword + "</span>的话题</a>";
    ...
    $("#search_input").focus(function(event) {
        ...
        if (keyword != "" && keyword != '请输入搜索内容') {
            var li = "<a onclick=editSearchKeyword('" + keyword + "',2) data-mtype=2 id='search_mtype_2'> 搜索含<span class='red'>" + keyword + "</span>的网页特效</a>\n\
...
<a onclick=editSearchKeyword('" + keyword + "',15) data-mtype=15 id='search_mtype_15'> 搜索含<span class='red'>" + keyword + "</span>的整站源码</a>\n\
