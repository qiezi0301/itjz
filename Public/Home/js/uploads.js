...
function checkIsOriginal(type) {
    var title = " 下载积分<span class='red'>*</span>";
    var description = " 适当的下载积分，赚取更多积分。";
    if (type == 1) {
        var points_type = $("input[name=points_type]:checked").val();
        if (points_type == 1) {
            title = " 下载火币<span class='red'>*</span>";
            description = " 赚取火币可以”申请提现“。";
        }
        $("#tr_points_type").show();
    } else {
        $("#tr_points_type").hide();
