jQuery(function() {
    ...
    function setState( val ) {
        ...
        switch ( state ) {
            ...
            case 'ready':
                ...
                $( '#singlefilePicker2' ).removeClass( 'element-invisible');
            ...
            case 'uploading':
                $( '#singlefilePicker2' ).addClass( 'element-invisible' );
                $progress.show();
                $upload.text( '暂停上传' );
                break;
    ...
    uploader.onFileQueued = function( file ) {
        if (fileCount!=0) {
            ...
            var n = str.split("_");
            n[2]-=1;
            var str2=n[0]+"_"+n[1]+'_'+n[2];
            uploader.removeFile( str2 );
